...
void main()
{
	...
	g_house.addEdge(3,4);
	g_house.addEdge(0,4);
	cout << "House: " << g_house.colorEdgesGIS(colors_house) << endl;
	...
	cout << "Houses: " << g_houses.colorEdgesGIS(colors_houses) << endl;
	...
	cout << "Spider: " << g_spider.colorEdgesGIS(colors_spider) << endl;
	...
	//g_penta.addEdge(1,4);
	//g_penta.addEdge(2,4);
	//cout << "Penta: " << g_penta.colorEdgesGIS(colors_penta) << endl;
	...
	//g_hex.addEdge(3,5);
	//g_hex.addEdge(4,5);
	//cout << "Hex: " << g_hex.colorEdgesGIS(colors_hex) << endl;
	//clear(colors_hex,6);
	//
	...
	//cout << "New design: " << g_newdesign.colorEdgesGIS(colors_newdesign) << endl;
